...
difference(){
    linear_extrude(13) offset(1.5) offset(-1.5) square([40,20],center=true);
   translate([5,0,2.5]) linear_extrude(10) offset(.2) projection(cut=true) translate([0,0,-3]) hull() xiao();
    ...
    translate([0,0,13-1.5]) linear_extrude(5) offset(1.5) offset(-1.5) square([40-1,20-1],center=true);
...
translate([-9,0,5]) cylinder(d=18,h=10);
    ...
    translate([36,15]/2) cylinder(d=5,h=5,center=true);
    translate([-36,15]/2) cylinder(d=5,h=5,center=true);
    translate([36,-15]/2) cylinder(d=5,h=5,center=true);
    translate([-36,-15]/2) cylinder(d=5,h=5,center=true);
